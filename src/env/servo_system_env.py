...
class ServoSystemEnv(gym.Env):
	def __init__(self):
		...
		self.rad_next_next = 0.0    # Speed at the next two moment
		...
		# extended system id.
		self.SystemsLists = [i for i in self.SystemsList for j in range(int(len(self.times)/args.change_times) + 1)]
